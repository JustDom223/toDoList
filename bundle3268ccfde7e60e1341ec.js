  ...
  \******************************************/
      /***/ (
        ...
        /* harmony import */ var _projects_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./projects.js */ "./src/script/projects.js");
        /* harmony import */ var _populateMain_js__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./populateMain.js */ "./src/script/populateMain.js",
          );
        /* harmony import */ var _localStorage_js__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ./localStorage.js */ "./src/script/localStorage.js",
          );

        function initializeProjects() {
          const currentDate = new Date();
          const projectCards = (0,
          _projects_js__WEBPACK_IMPORTED_MODULE_0__.getProjects)()
            .filter((project) => {
            ...
            .map((project) => {
              ...
              projectTasksButtonElement.addEventListener("click", () => {
                (0, _populateMain_js__WEBPACK_IMPORTED_MODULE_1__["default"])(
                  "taskButton",
                  project.title,
                );
              });
              ...
              projectDeleteButtonElement.addEventListener("click", () => {
                ...
                (0, _projects_js__WEBPACK_IMPORTED_MODULE_0__.deleteProject)(
                  projectTitle,
                );
                (0,
                _localStorage_js__WEBPACK_IMPORTED_MODULE_2__.updateLocalStorage)();
                (0, _populateMain_js__WEBPACK_IMPORTED_MODULE_1__["default"])(
                  "projects",
                );
              });
...
//# sourceMappingURL=bundle3268ccfde7e60e1341ec.js.map
