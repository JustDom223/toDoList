...
`,
          "",
          {
            ...
            names: [],
            mappings:
              "AAAA;EACE,sCAAsC;EACtC,yCAAyC;EACzC,sCAAsC;AACxC;;AAEA;EACE,yCAAyC;EACzC,mCAAmC;EACnC,yCAAyC;AAC3C;AACA;;;GAGG;;AAEH;EACE,mBAAmB;EACnB,aAAa;EACb,8BAA8B;EAC9B,mCAAmC;AACrC;;AAEA;EACE,4CAA4C;EAC5C,iCAAiC;EACjC,gBAAgB;EAChB,aAAa;AACf;;AAEA;EACE,4CAA4C;EAC5C,iCAAiC;EACjC,gBAAgB;EAChB,aAAa;AACf;;AAEA;EACE,gBAAgB;EAChB,aAAa;AACf;;AAEA;EACE,4CAA4C;EAC5C,iCAAiC;EACjC,gBAAgB;EAChB,aAAa;AACf;;AAEA,iBAAiB;AACjB;EACE,4CAA4C;EAC5C,iCAAiC;EACjC,aAAa;EACb,sCAAsC;EACtC,4BAA4B;AAC9B;;AAEA;EACE,4CAA4C;EAC5C,mBAAmB;EACnB,gBAAgB;EAChB,oBAAoB;EACpB,YAAY;EACZ,aAAa;EACb,iBAAiB;EACjB,gBAAgB;EAChB,UAAU;AACZ;;AAEA;EACE,aAAa;EACb,aAAa;EACb,YAAY;EACZ,sBAAsB;EACtB,6BAA6B;AAC/B;;AAEA;EACE,gBAAgB;EAChB,iBAAiB;AACnB;;AAEA;EACE,oBAAoB;EACpB,kBAAkB;AACpB",
            sourcesContent: [
              ":root {\n  --main-color-darkmode: rgb(39, 39, 39);\n  --font-color-darkmode: rgb(109, 197, 255);\n  --card-color-darkmode: rgb(95, 94, 94);\n}\n\n:root.special {\n  --main-color-darkmode: rgb(255, 255, 255);\n  --font-color-darkmode: rgb(0, 0, 0);\n  --card-color-darkmode: rgb(221, 221, 221);\n}\n/* \n*{\n    border: solid red 1px;\n} */\n\n#content {\n  height: fit-content;\n  display: grid;\n  grid-template-columns: 1fr 6fr;\n  grid-template-rows: 100px 12fr 50px;\n}\n\nheader {\n  background-color: var(--main-color-darkmode);\n  color: var(--font-color-darkmode);\n  grid-column: 1/3;\n  grid-row: 1/2;\n}\n\n#sidebar {\n  background-color: var(--main-color-darkmode);\n  color: var(--font-color-darkmode);\n  grid-column: 1/2;\n  grid-row: 2/3;\n}\n\nmain {\n  grid-column: 2/3;\n  grid-row: 2/3;\n}\n\nfooter {\n  background-color: var(--main-color-darkmode);\n  color: var(--font-color-darkmode);\n  grid-column: 1/3;\n  grid-row: 3/4;\n}\n\n/* Main content */\nmain {\n  background-color: var(--main-color-darkmode);\n  color: var(--font-color-darkmode);\n  display: grid;\n  grid-template-columns: 1fr 1fr 1fr 1fr;\n  /* flex-direction: column; */\n}\n\n.jobCard {\n  background-color: var(--card-color-darkmode);\n  border-radius: 12px;\n  box-shadow: 10px;\n  justify-self: center;\n  margin: 20px;\n  padding: 20px;\n  min-height: 150px;\n  max-width: 200px;\n  width: 1fr;\n}\n\n.projectForm {\n  display: flex;\n  height: 600px;\n  width: 600px;\n  flex-direction: column;\n  justify-content: space-around;\n}\n\n.button {\n  max-width: 100px;\n  max-height: 100px;\n}\n\n#projectButton {\n  justify-self: center;\n  align-self: center;\n}\n",
            ],
            sourceRoot: "",
...
*/
  ...
  \****************************************/
      /***/ (
        ...
        /* harmony import */ var _script_populateMain__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
        ...
        function createSidebar() {
          ...
          sideBarTabs.addEventListener("click", (event) => {
            ...
            if (clickedTab.classList.contains("tab")) {
              ...
              const newMainContent = (0,
              _script_populateMain__WEBPACK_IMPORTED_MODULE_0__["default"])(
                clickedElementId,
              );
        ...
        function initializeProjects() {
          ...
          _projects__WEBPACK_IMPORTED_MODULE_0__.getProjects)()
            ...
            .map((project) => {
              ...
              const projectDeleteButtonElement =
                document.createElement("input");
              ...
              projectDeleteButtonElement.addEventListener("click", () => {
                ...
                (0, _projects__WEBPACK_IMPORTED_MODULE_0__.deleteProject)(
                  projectTitle,
                );
                (0,
                _localStorage__WEBPACK_IMPORTED_MODULE_2__.updateLocalStorage)();
                (0, _populateMain__WEBPACK_IMPORTED_MODULE_1__["default"])(
                  "projects",
                );
              });
  ...
  \***************************************/
      /***/ (
        ...
        function initializeTasks(projectTitle) {
          const project = (0,
          _projects__WEBPACK_IMPORTED_MODULE_0__.getProjects)().find(
  ...
  \************************************/
      /***/ (
        ...
        /* harmony import */ var _createNewProject__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ./createNewProject */ "./src/script/createNewProject.js",
          );
        /* harmony import */ var _createNewTask__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! ./createNewTask */ "./src/script/createNewTask.js",
          );
        /* harmony import */ var _projects__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(/*! ./projects */ "./src/script/projects.js");

        function createTaskButton(projectTitle) {
          // Access existing elements
          const selectedProject = (0,
          _projects__WEBPACK_IMPORTED_MODULE_4__.getProjects)().find(
            (project) => project.title === projectTitle,
          );
          const dialogElement = document.querySelector("dialog");
          ...
          taskButtonElement.addEventListener("click", () => {
            ...
            dialogElement.appendChild(
              (0, _createNewTask__WEBPACK_IMPORTED_MODULE_3__["default"])(),
            );
        ...
        function createProjectButton() {
          ...
          projectButtonElement.addEventListener("click", () => {
            dialogElement.textContent = "";
            dialogElement.appendChild(
              (0, _createNewProject__WEBPACK_IMPORTED_MODULE_2__["default"])(),
            );
            dialogElement.showModal();
          });
  ...
  \**********************/
    ...
    /* harmony import */ var _pageManipulaton_header__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(
        /*! ./pageManipulaton/header */ "./src/pageManipulaton/header.js",
      );
    /* harmony import */ var _pageManipulaton_sideBar__WEBPACK_IMPORTED_MODULE_2__ =
      __webpack_require__(
        /*! ./pageManipulaton/sideBar */ "./src/pageManipulaton/sideBar.js",
      );
    /* harmony import */ var _pageManipulaton_main__WEBPACK_IMPORTED_MODULE_3__ =
      __webpack_require__(
        /*! ./pageManipulaton/main */ "./src/pageManipulaton/main.js",
      );
    /* harmony import */ var _pageManipulaton_footer__WEBPACK_IMPORTED_MODULE_4__ =
      __webpack_require__(
        /*! ./pageManipulaton/footer */ "./src/pageManipulaton/footer.js",
      );
    /* harmony import */ var _script_localStorage__WEBPACK_IMPORTED_MODULE_5__ =
      __webpack_require__(
        /*! ./script/localStorage */ "./src/script/localStorage.js",
      );
    /* harmony import */ var _script_populateMain__WEBPACK_IMPORTED_MODULE_6__ =
      __webpack_require__(
        /*! ./script/populateMain */ "./src/script/populateMain.js",
      );
    ...
    document.addEventListener("DOMContentLoaded", () => {
      (0,
      _script_localStorage__WEBPACK_IMPORTED_MODULE_5__.fetchLocalStorage)();
      ...
      contentElement.appendChild(
        (0, _pageManipulaton_header__WEBPACK_IMPORTED_MODULE_1__["default"])(),
      );
      contentElement.appendChild(
        (0, _pageManipulaton_sideBar__WEBPACK_IMPORTED_MODULE_2__["default"])(),
      );
      contentElement.appendChild(
        (0, _pageManipulaton_main__WEBPACK_IMPORTED_MODULE_3__["default"])(),
      );
      contentElement.appendChild(
        (0, _pageManipulaton_footer__WEBPACK_IMPORTED_MODULE_4__["default"])(),
      );

      (0, _script_populateMain__WEBPACK_IMPORTED_MODULE_6__["default"])(
        "projects",
      );
    });
  })();
...
//# sourceMappingURL=bundleac18d563939df8ceb781.js.map
